...
# raakt een rijtje van vier uit balans; dan lees je de knoppen niet meer, maar scan je ze.
HEB_KORT = 42

# Verhuisd uit grieks_app.py, zodat de Streamlit-app ze ook kan
# gebruiken: die kan dat bestand niet importeren, want het start de
# NiceGUI-server zodra je het inleest. Het is taalkennis en geen
# schermwerk, dus hier is de juiste plek.
# ---------------------------------------------------------------- de betekenis uitlezen
...
def heb_goed(antwoord, w, vergelijk):
    ...
    'vergelijk' is de functie die twee Nederlandse betekenissen tegen elkaar houdt --
    check_betekenis. Die staat in elke app apart (de ene is uit de andere gegenereerd) en
    kan hier dus niet geïmporteerd worden; vandaar dat hij wordt meegegeven."""
    return any(vergelijk(antwoord, kandidaat)
